...
const routes = {
  ...
  chastnym: {
    ...
    twitterDescription: "Навесы, ворота, ограждения и мелкая металлообработка в Сочи и Адлере.",
    jsonLd: [
      serviceLd({
      ...
      faqLd([
        [
          ...
          "И с теми, и с другими. Стоимость, порядок оплаты и документы согласуем перед началом работ.",
        ],
        [
          "Нужен ли чертёж?",
          "Нет. Достаточно фотографии места, размеров и эскиза от руки. Если размеров нет, обсудим возможность замера.",
        ],
        [
          "Выезжаете на замер?",
          "Возможность и стоимость выезда по Сочи и Адлеру согласуем при обращении. Для навесов и ворот нужны точные размеры.",
        ],
        [
  ...
  metalloobrabotka: {
    ...
    description:
      "Хомуты, кольца для каркасов свай, арматурные каркасы БНС, закладные детали, гибка арматуры и трубы, резка листа. Свой цех в Адлере на ул. Гастелло, расчёт по вашим размерам.",
    canonical: "https://karkas-invest.ru/metalloobrabotka/",
    ogTitle: "Металлообработка в Сочи — хомуты, кольца, гибка, закладные",
    ogDescription:
      "Мелкие металлоизделия и обработка металла в Адлере: от одной штуки, расчёт по вашим размерам.",
    ...
    jsonLd: [
      ...
      faqLd([
        ["Сколько штук минимум?", "Делаем и от одной штуки. Разовые заказы берём."],
        [
          "Нужен ли чертёж?",
        ...
        [
          "Как быстро готово?",
          "Срок зависит от изделия, количества и загрузки цеха. Согласуем его при расчёте.",
        ],
        [
          "Как оплатить?",
          "Способ и порядок оплаты согласуем при оформлении заказа. Организациям выставим счёт.",
        ],
      ]),
    ],
  },
  ...
  "svarochnye-raboty": {
    ...
    jsonLd: [
      ...
      faqLd([
        [
          "Выезжаете на замер?",
          "Возможность и стоимость выезда по Сочи и Адлеру согласуем при обращении. Для навесов, ворот и лестниц нужны точные размеры.",
        ],
        [
          "Можно заказать монтаж?",
          "Возможность, состав и стоимость монтажных работ согласуем при расчёте заказа.",
        ],
        [
        ...
        [
          ...
          "Да. Стоимость, порядок оплаты и документы согласуем перед началом работ.",
        ],
      ]),
    ],
  },
